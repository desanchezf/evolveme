...
JAZZMIN_SETTINGS = {
    ...
    "icons": {
        ...
        "gym.routineday": "fas fa-calendar-day",
        "gym.session": "fas fa-calendar-check",
        "gym.trainingsession": "fas fa-calendar-alt",
        # IA
        ...
        "ia.usermodelprompt": "fas fa-user-cog",
        # Periodic Tasks (django-celery-beat)
        "django_celery_beat.clockedschedule": "fas fa-clock",
        "django_celery_beat.crontabschedule": "fas fa-terminal",
